...
import com.marjan.cervexa.SplashActivity;
...
public abstract class SplashActivityBinding extends ViewDataBinding {
    ...
    public static SplashActivityBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (SplashActivityBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.camera_activity, viewGroup, z, obj);
    }
    ...
    public static SplashActivityBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (SplashActivityBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.camera_activity, null, false, obj);
    }
    ...
    public static SplashActivityBinding bind(View view, Object obj) {
        return (SplashActivityBinding) bind(obj, view, R.layout.camera_activity);
    }
}
