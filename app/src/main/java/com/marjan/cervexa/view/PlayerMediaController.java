...
public class PlayerMediaController extends FrameLayout {
    ...
    public PlayerMediaController(Context context, AttributeSet attributeSet) {
        ...
        this.mLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: com.marjan.cervexa.view.PlayerMediaController.1
        ...
        this.needHide = true;
        this.mHandler = new Handler(new Handler.Callback() { // from class: com.marjan.cervexa.view.PlayerMediaController.2
        ...
        this.mPauseListener = new View.OnClickListener() { // from class: com.marjan.cervexa.view.PlayerMediaController.3
        ...
        this.mSeekListener = new SeekBar.OnSeekBarChangeListener() { // from class: com.marjan.cervexa.view.PlayerMediaController.4
