...
import com.marjan.cervexa.dialog.ShareDialog;
...
public class PreviewPhotoActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        final int i = intent.getExtras().getInt("KEY_POSITION");
        ...
        this.shareView.setOnClickListener(new View.OnClickListener() { // from class: com.marjan.cervexa.activity.PreviewPhotoActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ShareDialog.newInstance().setOnClickListener(new ShareDialog.OnClickListener() { // from class: com.marjan.cervexa.activity.PreviewPhotoActivity.1.1
                    @Override // com.marjan.cervexa.dialog.ShareDialog.OnClickListener
