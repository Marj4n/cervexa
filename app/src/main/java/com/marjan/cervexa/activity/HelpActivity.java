...
import com.marjan.cervexa.databinding.HelpActivityBinding;
...
public class HelpActivity extends CameraBaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.binding.ivR.setOnClickListener(new View.OnClickListener() { // from class: com.marjan.cervexa.activity.HelpActivity.1
        ...
        this.binding.ivL.setOnClickListener(new View.OnClickListener() { // from class: com.marjan.cervexa.activity.HelpActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.binding.back.setOnClickListener(new View.OnClickListener() { // from class: com.marjan.cervexa.activity.HelpActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
