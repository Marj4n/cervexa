...
public class USBVendorId {
    ...
    static {
        ...
        IDS.put(PointerIconCompat.TYPE_CELL, "Mitsumi");
        IDS.put(PointerIconCompat.TYPE_TEXT, "HP Inc.");
        ...
        IDS.put(PointerIconCompat.TYPE_GRABBING, "Xilinx Inc.");
        IDS.put(10226, "Sibridge Tech.");
        IDS.put(1026, "ALi Corporation");
        IDS.put(UsbId.VENDOR_FTDI, "Future Technology Devices International Limited");
        IDS.put(10275, "Dongguan Jiumutong Industry Co., Ltd.");
        IDS.put(10289, "Power Integrations");
        IDS.put(10291, "Oculus VR, Inc.");
        IDS.put(BuildConfig.VERSION_CODE, "HIGH TEK HARNESS ENTERPRISE CO., LTD.");
        ...
        IDS.put(UsbId.VAN_OOIJEN_TECH_TEENSYDUINO_SERIAL, "STMicroelectronics");
        ...
        IDS.put(UsbId.VENDOR_PROLIFIC, "Prolific Technology, Inc.");
        ...
        IDS.put(UsbId.VENDOR_SILABS, "Silicon Laboratories, Inc.");
