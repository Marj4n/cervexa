...
public class MediaVideoEncoder extends MediaEncoder implements IVideoEncoder {
    ...
    public MediaVideoEncoder(MediaMuxerWrapper mediaMuxerWrapper, int i, int i2, MediaEncoderListener mediaEncoderListener) {
    ...
    @Override // com.serenegiant.usb.encoder.MediaEncoder, com.serenegiant.usb.encoder.IVideoEncoder
    ...
    public void setEglContext(EGLBase.IContext iContext, int i) {
        this.mRenderHandler.setEglContext(iContext, i, this.mSurface, true);
    }
