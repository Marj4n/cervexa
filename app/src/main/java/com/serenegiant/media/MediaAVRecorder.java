...
public class MediaAVRecorder extends AbstractMediaAVRecorder {
    ...
    public MediaAVRecorder(Context context, RecorderCallback recorderCallback, String str, int i) throws IOException {
        super(context, recorderCallback, (String) null, str, i);
    }

    public MediaAVRecorder(Context context, RecorderCallback recorderCallback, String str, String str2, int i) throws IOException {
        super(context, recorderCallback, str, str2, i);
    }

    public MediaAVRecorder(Context context, RecorderCallback recorderCallback, int i, String str, String str2) throws IOException {
        super(context, recorderCallback, i, str, str2);
    }

    public MediaAVRecorder(Context context, RecorderCallback recorderCallback, DocumentFile documentFile) throws IOException {
        super(context, recorderCallback, documentFile);
    }

    public MediaAVRecorder(Context context, RecorderCallback recorderCallback, String str) throws IOException {
